...
<head>
    ...
    <style>
        ...
        .hero {
            background-image: url({{asset('storage/welcome/welcomeSearchBackground.jpg')}});
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 text-center">
                    <img src="{{asset('storage/welcome/home1.jpg')}}" alt="Best Prices" class="mb-3">
                    <h3>Best Prices</h3>
                    <p>Find the best deals on hotels, flights, and more.</p>
                </div>
                <div class="col-md-4 text-center">
                    <img src="{{asset('storage/welcome/home2.jpeg')}}" alt="Wide Selection" class="mb-3">
                    <h3>Wide Selection</h3>
                    <p>Choose from a wide range of destinations and accommodations.</p>
                </div>
                <div class="col-md-4 text-center">
                    <img src="{{asset('storage/welcome/home3.jpg')}}" alt="Customer Support" class="mb-3">
