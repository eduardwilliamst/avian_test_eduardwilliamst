...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="<?php echo e(route('history.index')); ?>" class="nav-link <?php echo e(Request::is('history') ? 'active' : ''); ?>">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="<?php echo e(route('penjualan.index')); ?>" class="nav-link <?php echo e(Request::is('penjualan') ? 'active' : ''); ?>">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="<?php echo e(route('areaSales.index')); ?>" class="nav-link <?php echo e(Request::is('areaSales') ? 'active' : ''); ?>">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="<?php echo e(route('sales.index')); ?>" class="nav-link <?php echo e(Request::is('sales') ? 'active' : ''); ?>">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; <a href="http://adminlte.io">Test</a>.</strong>
            All rights reserved.
        </footer>
...
</html><?php /**PATH E:\Kerjaan\avian\avian_test\resources\views/layouts/adminlte.blade.php ENDPATH**/ ?>